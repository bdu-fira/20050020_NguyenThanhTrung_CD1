...
namespace WebsiteNoiThat.Areas.Admin.Controllers
{
    public class OrdersController : HomeController
    {
        ...
        public ActionResult Delete(int? id)
        {
            ...
            return View(order); // Trả về view để người dùng xác nhận xóa
        }


        [HasCredential(RoleId = "DELETE_ORDER")]
        [HttpPost, ActionName("Delete")] // Đảm bảo phương thức POST có ActionName là "Delete"
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            return RedirectToAction("Show"); // Quay lại trang Show sau khi xóa
        }
